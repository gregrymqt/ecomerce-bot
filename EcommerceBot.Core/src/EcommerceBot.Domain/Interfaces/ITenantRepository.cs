...
public interface ITenantRepository
{
    ...
    Task<int> ReverseCreditsAsync(Guid tenantId, int amount, string type = "CHARGEBACK_REVERSAL", string description = "Estorno / Chargeback de créditos", string? referenceId = null, Guid? orderId = null);
