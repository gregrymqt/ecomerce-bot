 ...
 *
 * Painel de Analytics & Atribuição de Tráfego Pago do Lojista (Card 77).
 * Exibe Faturamento por Criativo (ad_id), Desempenho por Canal (utm_source),
 * Snippet de instalação do tracker.js e verificador de tag ativa na loja virtual.
 */
...
export const TrafficAnalyticsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#090D16] text-white p-4 sm:p-8 space-y-8 selection:bg-emerald-500 selection:text-black">
      <SEO
        title="Analytics & Tráfego Pago"
        description="Acompanhe vendas, faturamento por criativo e ROAS atribuído aos seus anúncios."
      />
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#1E293B] pb-6">
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-black text-white">
            Performance de Anúncios & Criativos
          </h1>
          <p className="text-xs text-slate-400 mt-0.5">
            Rastreamento de UTMs e conversão de pedidos vindos do Meta Ads, Google Ads e TikTok.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <>
          ...
          {/* 3. TABELA DE FATURAMENTO POR CRIATIVO (ad_id) */}
          <div className="rounded-2xl bg-[#15121B] border border-[#1E293B] p-6 shadow-xl space-y-4">
            <div>
