/**
 * src/components/ui/payment/CreditCardPaymentForm.tsx
 *
 * Componente de UI Atômico e Reutilizável de Formulário de Cartão de Crédito.
 * Implementa máscaras dinâmicas de cartão, validade (MM/AA), CVV, CPF/CNPJ,
 * seleção de parcelamento e acessibilidade WCAG.
 */
...
export interface CreditCardPaymentFormProps {
  ...
  amountBrl?: number;
  /** Estado de carregamento ao submeter o formulário */
  loading?: boolean;
  /** Texto personalizado para o botão principal de envio */
...
export const CreditCardPaymentForm: React.FC<CreditCardPaymentFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (showDocNumber && docNumber.length < 11) {
