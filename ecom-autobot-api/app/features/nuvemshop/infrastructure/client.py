...
class NuvemshopClient:
    ...
    async def get_product_images(self, product_id: int) -> List[Dict[str, Any]]:
        """
        Lista todas as imagens associadas a um produto na Nuvemshop via GET /v1/{store_id}/products/{product_id}/images.
        """
    ...
    async def upload_product_image(
        ...
        """
        Upload de imagem de produto via POST /v1/{store_id}/products/{product_id}/images.
        Aceita URL pública (src) ou Buffer/Base64 (attachment + filename).
        Trata limite de 250 imagens (HTTP 422).
        """
        url = f"{self.base_url}/products/{product_id}/images"
    ...
    async def update_product_image(
        ...
        """
        Atualiza posição ou atributos de uma imagem via PUT /v1/{store_id}/products/{product_id}/images/{image_id}.
        """
    ...
    async def delete_product_image(self, product_id: int, image_id: int) -> bool:
        """
        Remove uma imagem da galeria via DELETE /v1/{store_id}/products/{product_id}/images/{image_id}.
        """
        url = f"{self.base_url}/products/{product_id}/images/{image_id}"
        async with httpx.AsyncClient() as client:
            try:
    ...
    async def get_categories(self) -> List[Dict[str, Any]]:
        """
        Lista todas as categorias da loja na Nuvemshop via GET /v1/{store_id}/categories.
        """
    ...
    async def create_category(
        ...
        """
        Cria uma nova categoria na loja via POST /v1/{store_id}/categories.
        """
        url = f"{self.base_url}/categories"
        if hasattr(payload, "model_dump"):
            data = payload.model_dump(exclude_none=True)
    ...
    async def get_webhooks(self) -> List[Dict[str, Any]]:
        """
        Lista todos os webhooks cadastrados para a loja na Nuvemshop via GET /v1/{store_id}/webhooks.
        """
    ...
    async def create_webhook(
        ...
        """
        Cadastra um novo webhook na loja via POST /v1/{store_id}/webhooks.
        """
        url = f"{self.base_url}/webhooks"
        if hasattr(payload, "model_dump"):
            data = payload.model_dump(exclude_none=True)
    ...
    async def delete_webhook(self, webhook_id: int) -> bool:
        """
        Remove um webhook da loja via DELETE /v1/{store_id}/webhooks/{webhook_id}.
        """
